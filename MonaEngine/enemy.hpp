...
namespace mve {
	...
	class Enemy {
	public:
		Enemy(MveWindow& mveWindow, MveGameObject& gameObject, Math::Vector4D pos, Math::EntityState firstState);
		...
		EnemyDrawData getDrawData(Math::Vector4D Xp, Math::Matrix44 L, Math::Matrix44 LL); 
