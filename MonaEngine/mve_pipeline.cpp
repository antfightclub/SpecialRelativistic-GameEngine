...
MvePipeline::~MvePipeline() {
	...
	PipelineConfigInfo MvePipeline::defaultPipelineConfigInfo(uint32_t width, uint32_t height) {
		...
		// Rasterization state create info default config
		...
		// Multisample state create info default config
		...
		// Color blend attachment state default config
		...
		// Color blend state create info default config
		...
		// Depth stencil state create info default config
